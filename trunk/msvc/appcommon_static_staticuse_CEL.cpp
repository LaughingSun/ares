...
SCF_USE_STATIC_PLUGIN(addon_celgraph)
...
SCF_USE_STATIC_PLUGIN(pfanalogmotion)
SCF_USE_STATIC_PLUGIN(pfdynmove)
SCF_USE_STATIC_PLUGIN(pfwasdmove)
SCF_USE_STATIC_PLUGIN(pfbillboard)
SCF_USE_STATIC_PLUGIN(pfdamage)
SCF_USE_STATIC_PLUGIN(pfdefcam)
SCF_USE_STATIC_PLUGIN(pfdelegcam)
SCF_USE_STATIC_PLUGIN(pfengine)
SCF_USE_STATIC_PLUGIN(pfinput)
SCF_USE_STATIC_PLUGIN(pfinv)
SCF_USE_STATIC_PLUGIN(pfjump)
SCF_USE_STATIC_PLUGIN(pfgrab)
...
SCF_USE_STATIC_PLUGIN(pfnewcamera)
SCF_USE_STATIC_PLUGIN(pfpathfinder)
SCF_USE_STATIC_PLUGIN(pfportal)
SCF_USE_STATIC_PLUGIN(pfquest)
SCF_USE_STATIC_PLUGIN(pfwire)
SCF_USE_STATIC_PLUGIN(pfsound)
SCF_USE_STATIC_PLUGIN(pfsteer)
SCF_USE_STATIC_PLUGIN(pftest)
SCF_USE_STATIC_PLUGIN(pftools)
SCF_USE_STATIC_PLUGIN(pftrackingcam)
SCF_USE_STATIC_PLUGIN(pftrigger)
SCF_USE_STATIC_PLUGIN(pfwheeled)
SCF_USE_STATIC_PLUGIN(pfmessenger)
SCF_USE_STATIC_PLUGIN(pfdynworld)
SCF_USE_STATIC_PLUGIN(addon_dynworldload)
SCF_USE_STATIC_PLUGIN(pfzone)
SCF_USE_STATIC_PLUGIN(pfprojectile)
SCF_USE_STATIC_PLUGIN(stdphyslayer)
SCF_USE_STATIC_PLUGIN(elcm)
SCF_USE_STATIC_PLUGIN(sequences)
SCF_USE_STATIC_PLUGIN(triggers)
SCF_USE_STATIC_PLUGIN(rewards)
SCF_USE_STATIC_PLUGIN(parameters)
SCF_USE_STATIC_PLUGIN(ui_gridinv)
